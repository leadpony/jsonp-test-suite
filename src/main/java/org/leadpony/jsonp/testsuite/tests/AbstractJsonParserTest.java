...
/**
 * A skeletal test container for testing {@link JsonParser}.
 *
 * @author leadpony
 */
abstract class AbstractJsonParserTest {
    ...
    @Test
    @Ambiguous
    public void hasNextShouldThrowExceptionIfParserIsClosed() {
    ...
    @Test
    public void nextShouldThrowExceptionIfParserIsClosed() {
        JsonParser parser = createJsonParser("{}");
        parser.close();
    ...
    /**
     * Creates a JSON parser to test.
     *
     * @param json the JSON document to parse.
     * @return newly created instance of JSON parser.
     */
    protected abstract JsonParser createJsonParser(String json);
}
